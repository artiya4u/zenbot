...
module.exports = function container(conf) {
  ...
  exchange.historyScan = conf.historyScan || 'backward'

  // TODO: phase the use of the name out.. define a cleaner interface for exchanges, so its easier to define how to write one.
  exchange.name = 'SET-YUANTA'
  exchange.getName = function () {
    return 'SET-YUANTA'
  }

  exchange.getDirection = function () {
    return 'backward'
  }

  exchange.getMakerFee = function () {
    return 0.17
  }

  exchange.getTakerFee = function () {
    return 0.17
  }

  exchange.getProducts = function () {
    return require('./products.json')
  }

  exchange.getTrades = function (opts, cb) {
